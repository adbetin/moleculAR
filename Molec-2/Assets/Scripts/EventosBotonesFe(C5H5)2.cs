		...
		if(EventosBotonesFe_C5H5_2.activo){
			if(menu==1){
				...
				if(GUI.Button(new Rect(15, 15, 150, 50), "Eje C4")){
					Fe_C5H5_2.animation.PlayQueued("eje_C4");
				...
				if(GUI.Button(new Rect(15, 15, 150, 50), "Plano O")){
						Fe_C5H5_2.animation.PlayQueued("plano_Oa");
					
				}
				if(GUI.Button(new Rect(170, 15, 150, 50), "Plano Ov(a)")){
						Fe_C5H5_2.animation.PlayQueued("plano_Ob");
						
				}
				if(GUI.Button(new Rect(15, 70, 150, 50), "Plano Ov(b)")){
						Fe_C5H5_2.animation.PlayQueued("plano_Od");
						
				}
				if(GUI.Button(new Rect(170, 70, 150, 50), "Plano Od(a)")){
						Fe_C5H5_2.animation.PlayQueued("plano_Oc");
						
				}
				if(GUI.Button(new Rect(15, 125, 150, 50), "Plano Od(b)")){
						Fe_C5H5_2.animation.PlayQueued("plano_Oe");
