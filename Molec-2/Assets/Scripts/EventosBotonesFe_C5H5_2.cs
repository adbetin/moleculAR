...
public class EventosBotonesFe_C5H5_2 :    MonoBehaviour,
                                            IVirtualButtonEventHandler
{

    
    private GameObject Fe_C5H5_2;
    ...
    void Start()
    {
        ...
        Fe_C5H5_2 =GameObject.Find("Fe(C5H5)2");
		Fe_C5H5_2.SetActiveRecursively(true);
		menu=0;
	...
	private void OnGUI(){
		Debug.Log(EventosBotonesFe_C5H5_2.activo);
		if(EventosBotonesFe_C5H5_2.activo){
			if(menu==1){
				Debug.Log("Esta mostrando el boton ejes");
				if(GUI.Button(new Rect(15, 15, 150, 50), "Eje C5")){
					Fe_C5H5_2.animation.PlayQueued("eje_C5");
					Fe_C5H5_2.animation.PlayQueued("quieto");
				}
				if(GUI.Button(new Rect(170, 15, 150, 50), "Eje C5-2")){
					Fe_C5H5_2.animation.PlayQueued("eje_C5-2");
					Fe_C5H5_2.animation.PlayQueued("quieto");
				}
				if(GUI.Button(new Rect(325, 15, 150, 50), "Eje C5-3")){
					Fe_C5H5_2.animation.PlayQueued("eje_C5-3");
					Fe_C5H5_2.animation.PlayQueued("quieto");
				}
				if(GUI.Button(new Rect(15, 70, 150, 50), "Eje C5-4")){
					Fe_C5H5_2.animation.PlayQueued("eje_C5-4");
					Fe_C5H5_2.animation.PlayQueued("quieto");
				}
				if(GUI.Button(new Rect(170, 70, 150, 50), "Eje C2(a)")){
					Fe_C5H5_2.animation.PlayQueued("eje_C2a");
					Fe_C5H5_2.animation.PlayQueued("quieto");
				}
				if(GUI.Button(new Rect(325, 70, 150, 50), "Eje C2(b)")){
					Fe_C5H5_2.animation.PlayQueued("eje_C2b");
					Fe_C5H5_2.animation.PlayQueued("quieto");
				}
				if(GUI.Button(new Rect(15, 125, 150, 50), "Eje C2(c)")){
					Fe_C5H5_2.animation.PlayQueued("eje_C2c");
					Fe_C5H5_2.animation.PlayQueued("quieto");
				}
				if(GUI.Button(new Rect(170, 125, 150, 50), "Eje C2(d)")){
					Fe_C5H5_2.animation.PlayQueued("eje_C2d");
					Fe_C5H5_2.animation.PlayQueued("quieto");
				}
				if(GUI.Button(new Rect(325, 125, 150, 50), "Eje C2(e)")){
					Fe_C5H5_2.animation.PlayQueued("eje_C2e");
					Fe_C5H5_2.animation.PlayQueued("quieto");
				}
			}
			else if(menu==2){
				...
				if(GUI.Button(new Rect(15, 15, 150, 50), "Plano Od(a)")){
						Fe_C5H5_2.animation.PlayQueued("plano_Oda");
				}
				if(GUI.Button(new Rect(170, 15, 150, 50), "Plano Od(b)")){
						Fe_C5H5_2.animation.PlayQueued("plano_Odb");
				}
				if(GUI.Button(new Rect(325, 15, 150, 50), "Plano Od(c)")){
						Fe_C5H5_2.animation.PlayQueued("plano_Odc");
				}
				if(GUI.Button(new Rect(15, 70, 150, 50), "Plano Od(d)")){
						Fe_C5H5_2.animation.PlayQueued("plano_Odd");			
				}
				if(GUI.Button(new Rect(170, 70, 150, 50), "Plano Od(e)")){
						Fe_C5H5_2.animation.PlayQueued("plano_Ode");						
				}
				if(GUI.Button(new Rect(325, 70, 150, 50), "Todos los Planos")){
						Fe_C5H5_2.animation.PlayQueued("plano_todos");
				}
